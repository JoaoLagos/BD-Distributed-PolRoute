def execute_query(spark):
    """
    Query 2: Total de crimes por tipo e por segmento das ruas do distrito de IGUATEMI entre 2006 e 2016
    """
    query = """
    SELECT 
        c.segment_id,
    ...
    WHERE d.name = 'IGUATEMI' AND t.year BETWEEN 2006 AND 2016
